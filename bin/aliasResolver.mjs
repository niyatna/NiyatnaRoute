 ...
 * `@niyatna/open-sse/services/usage` fail with `ERR_MODULE_NOT_FOUND`.
 ...
 *   - `@/*`             → `./src/*`
 *   - `@niyatna/open-sse`    → `./open-sse/index.ts`
 *   - `@niyatna/open-sse/*`  → `./open-sse/*`
 ...
 *
 * Each entry:
 *   prefix  — specifier prefix to match (e.g. `"@/"`, `"@niyatna/open-sse/"`)
 ...
 *             prefix *without* a trailing slash (e.g. `@niyatna/open-sse` →
...
export const ALIAS_MAP = [
  ...
  { prefix: "@niyatna/open-sse/", target: "open-sse", exact: false },
  { prefix: "@niyatna/open-sse", target: "open-sse", exact: true },
];
 ...
 *   "@/..."                     → <root>/src/...
 *   "@niyatna/open-sse/..."   → <root>/open-sse/...
 *   "@niyatna/open-sse"       → <root>/open-sse/index.*
 *
...
export function resolveAlias(specifier, root) {
  ...
  // Exact match (e.g. `@niyatna/open-sse` with no trailing path) →
