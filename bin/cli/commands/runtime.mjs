...
/**
 * Shared repair action used by both `niyatnaroute runtime repair` and the
 * top-level `niyatnaroute repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `niyatnaroute repair` invokes the SAME action
  // as `niyatnaroute runtime repair` (no duplicated logic). Surfaced in the
