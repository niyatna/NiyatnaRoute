...
// local `droid` CLI. NiyatnaRoute already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through NiyatnaRoute.
//
...
// back to stored CLI credentials only when omitted. NiyatnaRoute does NOT read
