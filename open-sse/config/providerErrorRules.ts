...
// upstream quota is per-account, and a single NiyatnaRoute provider entry maps to
// one user account. Multiple NiyatnaRoute connections under the same provider
