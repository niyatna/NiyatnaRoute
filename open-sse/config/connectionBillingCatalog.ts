...
export const CONNECTION_BILLING_CATALOG: readonly ConnectionBillingEntry[] = [
  ...
  },
  {
    ...
    reason:
      ...
      "NiyatnaRoute already tracks their reset windows (see antigravityCredits.ts).",
  },
  {
    provider: "cursor",
    authType: "oauth",
    ...
    reason:
      ...
      "can be enabled per account and NiyatnaRoute cannot observe that setting. Recorded " +
