 ...
 *
 * Goal: ensure the final request body NiyatnaRoute sends to Anthropic's
 ...
 *
 * Related: NiyatnaRoute issue #2260.
 */
...
export interface InjectBillingHeaderOp {
   ...
   *   - niyatnaroute-daystamp: sha256(YYYY-MM-DD + version).slice(0,3)
   */
  versionFormat: "ex-machina" | "niyatnaroute-daystamp";
  /**
 ...
 * proven against the live NiyatnaRoute deployment (call log
...
/**
 * Compute the `cc_version` suffix per the NiyatnaRoute native-OAuth algorithm:
...
export function buildBillingHeaderValue(
  ...
  const suffix =
    ...
    (options.versionFormat === "niyatnaroute-daystamp"
