 ...
 * NiyatnaRoute keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers NiyatnaRoute emits across formats: OpenAI `data: [DONE]`,
