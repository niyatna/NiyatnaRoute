 ...
 *
 *   1. The client (NiyatnaRoute) generates an ephemeral RSA keypair.
 ...
 *   5. NiyatnaRoute decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + NiyatnaRoute conventions. `fetch` is intentionally the
