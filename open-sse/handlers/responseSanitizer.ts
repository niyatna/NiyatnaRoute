...
export const OMIT_STREAMING_CHUNK_MARKER = "__niyatnaroute_omit_streaming_chunk";
...
export interface SanitizeOpenAIResponseOptions {
   ...
   * Wired to the `x-niyatnaroute-strip-reasoning` request header for clients whose
