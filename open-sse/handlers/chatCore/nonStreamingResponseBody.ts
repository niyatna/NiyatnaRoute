 ...
 * Override with `NIYATNAROUTE_MAX_NONSTREAMING_RESPONSE_BYTES`.
 */
export const MAX_NONSTREAMING_RESPONSE_BYTES = (() => {
  const parsed = Number.parseInt(String(process.env.NIYATNAROUTE_MAX_NONSTREAMING_RESPONSE_BYTES), 10);
