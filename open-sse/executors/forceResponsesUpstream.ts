 ...
 * NiyatnaRoute downgrades it to `/chat/completions` — so the MCP namespaces never
...
export function shouldForceResponsesUpstream(
  ...
  if (providerSpecificData?._niyatnarouteForceResponsesUpstream === true) return true;
