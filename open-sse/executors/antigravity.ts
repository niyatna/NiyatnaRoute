...
function sanitizeAntigravityGeminiRequest(
  ...
  // Missing settings stay absent so NiyatnaRoute does not silently weaken upstream safety.
...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set NIYATNAROUTER_ALLOW_BODY_PROJECT_OVERRIDE=1.
    ...
    const allowBodyProjectOverride = process.env.NIYATNAROUTE_ALLOW_BODY_PROJECT_OVERRIDE === "1";
    ...
    // Opt-in escape hatch: set NIYATNAROUTE_ALLOW_BODY_PROJECT_OVERRIDE=1.
    let projectId =
