 ...
 *
 * NiyatnaRoute → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only NiyatnaRoute-style backwards-compat aliases where users
...
// NiyatnaRoute uses dot-notation user IDs (e.g. "gpt-5.5-high").
