 ...
 * to OpenAI Chat Completions chunks by reusing NiyatnaRoute's own translators
 ...
 * adapted to TypeScript + NiyatnaRoute's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      ...
      clientHeaders?.["x-niyatnaroute-thinking-marker"] ??
      null,
