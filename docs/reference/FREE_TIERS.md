...
| **Gated recurring grant (needs approval)**  | **~6M**           | Same as above, but for providers requiring phone verification, credit card on file, or explicit application.                                                                                                                                                                     |
| **First month (with one-time grants)**      | **~2.22B**        | Steady recurring + one-time sign-up credits. Good for getting started, but not sustainable indefinitely.                                                                                                                                                                        |
