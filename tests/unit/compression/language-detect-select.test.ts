...
import { detectCompressionLanguage } from "@niyatna/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@niyatna/open-sse/services/compression/caveman.ts";
