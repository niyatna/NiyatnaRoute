...
import { detectCompressionLanguage } from "@niyatnaroute/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@niyatnaroute/open-sse/services/compression/caveman.ts";
