 ...
 * spawned with a FIXED 512MB heap default (`niyatnaroute serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `NIYATNAROUTE_MEMORY_MB` still wins
...
test("#5172 an explicit NIYATNAROUTE_MEMORY_MB still wins over the calibrated default", () => {
