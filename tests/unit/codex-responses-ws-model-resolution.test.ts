 ...
 * "gpt-5.5" and streams a response; without this re-resolution NiyatnaRoute routed
...
// A resolver mirroring NiyatnaRoute's real behavior: bare "gpt-5.5" → openrouter,
