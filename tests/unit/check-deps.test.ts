...
test("6A.8: discoverManifests finds root and workspace package.json files", () => {
  ...
  assert.ok(
    manifests.includes("@niyatnaroute/opencode-plugin/package.json"),
    "@niyatnaroute/opencode-plugin/package.json must be included"
  );
  assert.ok(
    manifests.includes("@niyatnaroute/opencode-provider/package.json"),
    "@niyatnaroute/opencode-provider/package.json must be included"
  );
});
