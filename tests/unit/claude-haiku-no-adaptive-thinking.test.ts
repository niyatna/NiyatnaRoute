...
import { normalizeClaudeHaikuConstraints } from "@niyatnaroute/open-sse/services/claudeHaikuConstraints.ts";
...
// Several NiyatnaRoute paths can still emit these on Haiku targets:
