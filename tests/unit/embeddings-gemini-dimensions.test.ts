...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "niyatnaroute-embeddings-gemini-dim-"));
...
// so NiyatnaRoute must forward `outputDimensionality` alongside `dimensions` for Gemini
