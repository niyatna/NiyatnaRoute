 ...
 *
 * Scope (minimal): only models that NiyatnaRoute already references throughout
 ...
 * provider registry. We do NOT restore models NiyatnaRoute deliberately curated
 * out (e.g. o1, gpt-4-turbo) nor re-add embedding/TTS/image entries that
 * NiyatnaRoute deliberately keeps in their own typed registries
