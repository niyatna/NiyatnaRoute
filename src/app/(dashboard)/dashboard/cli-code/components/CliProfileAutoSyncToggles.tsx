...
const CODEX_KEY = "NIYATNAROUTE_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "NIYATNAROUTE_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the NIYATNAROUTE_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
