...
const BIFROST_API_KEY = process.env.BIFROST_API_KEY || process.env.NIYATNAROUTE_BIFROST_KEY;
...
export async function POST(request: Request) {
  ...
  try {
    ...
    //    graph from pulling in 30MB of @niyatnaroute/open-sse when the user
