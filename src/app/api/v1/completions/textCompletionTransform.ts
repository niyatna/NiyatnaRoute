/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. NiyatnaRoute routes
 ...
 * the model they asked for, and the `x-niyatnaroute-model` response header
 ...
 * requested identifier (matching the `x-niyatnaroute-model` response header).
 */
