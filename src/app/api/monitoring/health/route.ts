...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@niyatnaroute/open-sse/services/rateLimitManager"),
      import("@niyatnaroute/open-sse/services/accountFallback"),
      import("@niyatnaroute/open-sse/services/requestDedup.ts"),
      import("@niyatnaroute/open-sse/services/quotaMonitor.ts"),
      import("@niyatnaroute/open-sse/services/sessionManager.ts"),
