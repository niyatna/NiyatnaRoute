...
async function rebuildHealthPayload(): Promise<unknown> {
  ...
  const [
    ...
    import("@niyatna/open-sse/services/requestDedup.ts"),
    import("@niyatna/open-sse/services/quotaMonitor.ts"),
    import("@niyatna/open-sse/services/sessionManager.ts"),
    import("@/lib/credentialHealth/cache"),
    import("@/lib/localHealthCheck"),
    import("@niyatna/open-sse/services/admission/runtime.ts"),
