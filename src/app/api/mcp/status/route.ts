...
import { getAuditStats, queryAuditEntries } from "@niyatnaroute/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@niyatnaroute/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.NIYATNAROUTE_MCP_ENFORCE_SCOPES === "true";
