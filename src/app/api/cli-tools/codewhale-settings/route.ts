...
/**
 * Render the NiyatnaRoute config block in CodeWhale TOML format.
...
// POST — write NiyatnaRoute settings to CodeWhale's config.toml (primary), and
...
// DELETE — remove NiyatnaRoute CodeWhale config (primary + legacy, if present)
