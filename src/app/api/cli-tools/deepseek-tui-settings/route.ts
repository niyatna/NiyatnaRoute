...
/**
 * Render the NiyatnaRoute config block in DeepSeek TUI TOML format.
...
// POST — write NiyatnaRoute settings to DeepSeek TUI config.toml
...
// DELETE — remove DeepSeek TUI NiyatnaRoute config
