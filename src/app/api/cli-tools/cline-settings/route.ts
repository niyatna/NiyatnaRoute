...
// Check if NiyatnaRoute is configured as OpenAI-compatible provider
...
// POST - Configure Cline to use NiyatnaRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_niyatnaroute";
...
// DELETE - Remove NiyatnaRoute OpenAI-compatible provider config
