...
/**
 * Render the NiyatnaRoute provider block in Forge TOML format.
 ...
 * Looks for the managed-by-NiyatnaRoute marker comment.
 */
...
// POST — write NiyatnaRoute settings to Forge config.toml
...
// DELETE — remove Forge NiyatnaRoute config
