...
// POST — write NiyatnaRoute settings to jcode config.json
export async function POST(request: Request) {
  ...
  try {
    ...
    // Merge NiyatnaRoute settings (jcode uses OpenAI-compatible config)
...
// DELETE — remove NiyatnaRoute settings from jcode config
