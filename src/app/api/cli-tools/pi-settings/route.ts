...
// POST — write NiyatnaRoute settings to Pi config.json
export async function POST(request: Request) {
  ...
  try {
    ...
    // Merge NiyatnaRoute settings (pi uses OpenAI-compatible config)
...
// DELETE — remove NiyatnaRoute settings from Pi config
