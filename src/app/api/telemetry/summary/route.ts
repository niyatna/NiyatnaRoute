...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@niyatnaroute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@niyatnaroute/open-sse/services/sessionManager.ts");
