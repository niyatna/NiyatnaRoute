...
const WS_BRIDGE_SECRET_HEADER = "x-niyatnaroute-ws-bridge-secret";
...
// server-ws.mjs (NIYATNAROUTE_WS_BRIDGE_SECRET). Without this carve-out the MANAGEMENT
...
function isValidWsBridgeRequest(ctx: PolicyContext): boolean {
  ...
  const expected = process.env.NIYATNAROUTE_WS_BRIDGE_SECRET || "";
