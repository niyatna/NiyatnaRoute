...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-niyatnaroute-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-niyatnaroute-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-niyatnaroute-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-niyatnaroute-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-niyatnaroute-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-niyatnaroute-cli-token";
 ...
 * token matches this process's NIYATNAROUTE_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-niyatnaroute-peer-ip";
 ...
 * proxy hop (e.g. NiyatnaRoute behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-niyatnaroute-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-niyatnaroute-peer-locality";
