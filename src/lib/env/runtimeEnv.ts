...
export const webRuntimeEnvSchema = z.object({
  ...
  NIYATNAROUTE_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  NIYATNAROUTE_PUBLIC_BASE_URL: optionalHttpUrl,
  NIYATNAROUTE_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  NIYATNAROUTE_PORT: optionalPortEnv,
