...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'niyatnaroute'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with NiyatnaRoute
...
-- Determines whether each provider uses NiyatnaRoute's native executor,
