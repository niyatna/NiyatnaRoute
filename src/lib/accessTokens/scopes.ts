 ...
 *
 * These tokens authorize the `niyatnaroute` CLI (and dashboard) to run *management*
 * commands against a (possibly remote) NiyatnaRoute server. They are distinct from
