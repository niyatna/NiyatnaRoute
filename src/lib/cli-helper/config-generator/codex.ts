 ...
 *   var named by `env_key` (`NIYATNA_API_KEY`), so the generated content is
...
export async function generateCodexConfig(options: {
  ...
  const header =
    "# Generated by NiyatnaRoute. The API key is read from the NIYATNA_API_KEY\n" +
