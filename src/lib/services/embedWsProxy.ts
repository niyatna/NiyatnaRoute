 ...
 *     is set explicitly. The NiyatnaRoute LOCAL_ONLY rule is enforced at the
...
declare global {
  var __niyatnarouteEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__niyatnarouteEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__niyatnarouteEmbedWsStarted = true;
