...
declare global {
  var __niyatnarouteCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__niyatnarouteCredentialCache) {
    globalThis.__niyatnarouteCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__niyatnarouteCredentialCache;
}
