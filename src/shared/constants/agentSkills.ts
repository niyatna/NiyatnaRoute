...
const REPO = "diegosouzapw/NiyatnaRoute";
const BRANCH = "main";
...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
  ...
  },
  {
    ...
    name: "Providers",
    description:
      "Manage provider connections, API keys, OAuth flows, and connection tests via the REST API. List, add, update, remove, and test AI provider integrations across NiyatnaRoute's 327-provider catalog.",
    category: "api",
    area: "providers",
    icon: "key",
  },
  ...
  },
  {
    ...
    name: "MCP Server",
    description:
      "Connect to the NiyatnaRoute MCP server (110 tools, 3 transports: SSE/stdio/HTTP). Covers routing, cache, compression, memory, skills, providers, and audit tools across 33 permission scopes.",
    category: "api",
    area: "mcp",
