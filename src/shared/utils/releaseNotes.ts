...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/niyatnaroute/NiyatnaRoute/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/niyatnaroute/NiyatnaRoute/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/niyatnaroute/NiyatnaRoute/blob/main/CHANGELOG.md";
