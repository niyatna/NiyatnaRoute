...
const footerLinks = {
  product: [
    ...
    {
      key: "changelog",
      href: "https://github.com/diegosouzapw/NiyatnaRoute/releases",
      external: true,
    },
  ],
  resources: [
  ...
  company: [
    { key: "about", href: "https://github.com/diegosouzapw/NiyatnaRoute", external: true },
    { key: "blog", href: "https://github.com/diegosouzapw/NiyatnaRoute/releases", external: true },
    {
      key: "contact",
