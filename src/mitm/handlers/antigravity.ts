 ...
 * `thinkingConfig`, …). The NiyatnaRoute router endpoint `/v1/chat/completions`
 ...
 *   - forward to `/v1/chat/completions` on the NiyatnaRoute router,
 ...
 * @param model      resolved NiyatnaRoute model string
