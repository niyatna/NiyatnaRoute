/**
 * Global Type Declarations for NiyatnaRoute
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    NIYATNAROUTE_PUBLIC_BASE_URL?: string;
    NIYATNAROUTE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    NIYATNAROUTE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    NIYATNAROUTE_BASE_URL?: string;
    NIYATNAROUTE_DISABLE_BACKGROUND_SERVICES?: string;
    NIYATNAROUTE_PORT?: string;
