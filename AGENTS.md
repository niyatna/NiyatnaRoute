...
| MCP Server    | `open-sse/mcp-server/`  | 63 tools (45 canonical + memory/skill/GitHub/pool/gamification/plugin/Notion/Obsidian/local-corpus/RTK modules), 3 transports (stdio / SSE / Streamable HTTP), 23 scopes |
