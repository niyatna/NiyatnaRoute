...
const IGNORE_FROM_CODE = new Set([
  ...
  // Antigravity bridge CLI helpers (bin/antigravity-bridge.mjs)
  "BRIDGE_PORT",
  "CERT_DIR",
  "ROUTER_URL",
  // Next.js port fallback in client hook useDisplayBaseUrl
  "NEXT_PUBLIC_PORT",
  // OpenWA service port override
  "OPENWA_SERVICE_PORT",
  // ChatGPT Web headless override
