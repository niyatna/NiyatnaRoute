...
const explicitBaseUrl = process.env.NIYATNAROUTE_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          NIYATNAROUTE_BASE_URL: baseUrl,
        }),
    NIYATNAROUTE_E2E_BOOTSTRAP_MODE: process.env.NIYATNAROUTE_E2E_BOOTSTRAP_MODE || "open",
  };
