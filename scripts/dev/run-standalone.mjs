...
// #2939: honor NIYATNAROUTE_MEMORY_MB (default 512), the same knob
// `niyatnaroute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.NIYATNAROUTE_MEMORY_MB);
