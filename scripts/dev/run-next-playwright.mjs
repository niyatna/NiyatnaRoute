...
const bootstrapMode = process.env.NIYATNA_E2E_BOOTSTRAP_MODE || "auth";
...
const testServerEnv = {
  ...
  NEXT_PUBLIC_NIYATNA_E2E_MODE: process.env.NEXT_PUBLIC_NIYATNA_E2E_MODE || "1",
  NIYATNA_DISABLE_BACKGROUND_SERVICES:
    process.env.NIYATNA_DISABLE_BACKGROUND_SERVICES || "true",
  NIYATNA_DISABLE_TOKEN_HEALTHCHECK: process.env.NIYATNA_DISABLE_TOKEN_HEALTHCHECK || "true",
  NIYATNA_DISABLE_LOCAL_HEALTHCHECK: process.env.NIYATNA_DISABLE_LOCAL_HEALTHCHECK || "true",
  NIYATNA_HIDE_HEALTHCHECK_LOGS: process.env.NIYATNA_HIDE_HEALTHCHECK_LOGS || "true",
  ...(bootstrapMode === "open"
    ? {
        INITIAL_PASSWORD: "",
        NIYATNA_E2E_PASSWORD: "",
        NIYATNA_API_KEY: "",
      }
    : {
        INITIAL_PASSWORD: playwrightPassword,
        NIYATNA_E2E_PASSWORD: playwrightPassword,
      }),
  ...(process.env.NIYATNA_USE_TURBOPACK
    ? {
        NIYATNA_USE_TURBOPACK: process.env.NIYATNA_USE_TURBOPACK,
      }
    : {}),
};
...
export function shouldUseWebpackForPlaywrightDev({ mode, env }) {
  ...
  return mode === "dev" && env.NIYATNA_USE_TURBOPACK === "0";
}
...
async function runBuildForStart() {
  ...
  if (process.env.NIYATNA_PLAYWRIGHT_SKIP_BUILD === "1") return;
