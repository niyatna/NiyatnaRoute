 ...
 *
 * Reusable Phase-3 VPS HTTP client for NiyatnaRoute combo live-smoke tests.
 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.niyatnaroute/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.niyatnaroute/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== NiyatnaRoute VPS Phase-3 Preflight ===");
