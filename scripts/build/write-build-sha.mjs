...
/**
 * write-build-sha.mjs — HEAD sentinel guard for NiyatnaRoute release builds.
 *
 * Writes NIYATNAROUTE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.NIYATNAROUTE_BUILD_SHA) {
    return process.env.NIYATNAROUTE_BUILD_SHA.trim();
  }
  try {
