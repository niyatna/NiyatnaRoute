...
description: Synchronise NiyatnaRoute configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.
---
...
Authenticates with the NiyatnaRoute cloud worker for remote access.
